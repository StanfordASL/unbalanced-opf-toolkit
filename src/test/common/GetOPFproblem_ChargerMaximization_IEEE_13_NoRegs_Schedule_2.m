function [opf_problem,model_importer] = GetOPFproblem_ChargerMaximization_IEEE_13_NoRegs_Schedule_2()
% Based on GetOPFproblem_ChargerMaximization_IEEE_13_NoRegs_Schedule but includes power factor constraints
% instead of constraining q to be 0
...
controllable_load_spec_array = [...
    uot.ControllableLoadSpec('charger_632_2','l632',[1,1,1],'p_min_va',0,'power_factor_min',power_factor_min);
    uot.ControllableLoadSpec('charger_675_9','l675',[1,1,1],'p_min_va',0,'power_factor_min',power_factor_min);
    uot.ControllableLoadSpec('charger_611_12','l611',[0,0,1],'p_min_va',0,'power_factor_min',power_factor_min);
    uot.ControllableLoadSpec('charger_652_13','l652',[1,0,0],'p_min_va',0,'power_factor_min',power_factor_min);
    ];
