classdef PowerFlowSurrogateSpec_Bernstein2017_LP_2 < uot.AbstractPowerFlowSurrogateSpec
    % Class to specify xx
    %
    % Synopsis::
    %
    ...
    methods
        function obj = PowerFlowSurrogateSpec_Bernstein2017_LP_2()
        end
    end
    ...
    methods
        function pf_surrogate = Create(obj,varargin)
            pf_surrogate = PowerFlowSurrogate_Bernstein2017_LP_2(obj,varargin{:});
        end
    end
end